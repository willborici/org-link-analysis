...
[[file:MultiDiGraph with 6 nodes and 15 edges]]
...
Connectivity Report for MultiDiGraph with 6 nodes and 15 edges:
 {'edge connectivity': 0, 'SCC': [{'Joe', 'Wilma', 'Will', 'Bob', 'Willa'}, {'Alice'}]} 
...
#+ATTR_HTML: :width 800px
[[file:Graph with 3 nodes and 2 edges]]
...
#+ATTR_HTML: :width 800px
[[file:DiGraph with 5 nodes and 5 edges]]
...
Connectivity Report for DiGraph with 5 nodes and 5 edges:
 {'SCC': [{'Will'}, {'Wilma'}, {'Willa'}, {'Bob'}, {'Alice'}], 'WCC': [{'Wilma', 'Will', 'Alice', 'Bob', 'Willa'}], 'reachability': 'weak'} 
...
#+ATTR_HTML: :width 800px
[[file:Graph with 5 nodes and 3 edges]]
...
Connectivity Report for Graph with 5 nodes and 3 edges:
 {'connected components': [{'Bob', 'Will', 'Wilma'}, {'Joe', 'Willa'}]} 
